...
Your new IP address is ${IPADDRESS}.
Go to <a href='http://${IPADDRESS}/ethminer.php'>http://${IPADDRESS}/ethminer.php</a> to launch ETH. 
Go to <a href='http://${IPADDRESS}/zecminer.php'>http://${IPADDRESS}/zecminer.php</a> to launch ZEC."
| ssmtp keymaster@iron-key.com
